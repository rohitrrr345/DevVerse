      ...
      <div className=" m-2 gap-2   ">
        ...
        <div className="mt-5">
          ...
          <div className="flex  justify-center items-center  ">
            <div className="flex flex-col justify-center shadow-2xl items-center   p-5 gap-2 w-64 break-normal  whitespace-normal">
            ...
            <div    className="flex flex-col shadow-2xl justify-center items-center p-5  m-2 gap-2 w-64 break-normal whitespace-normal">
...
<div className="form flex flex-col text-center gap-4">
  ...
  <p>We respect your inbox. No spam, promise ✌️</p>
